...
class MrpProduction(models.Model):
    ...
    #     dest_loc = loc_obj.browse(cr, uid, destination_location_id, context=context)
    ...
    #     stock_move.write(cr,uid, move_id, {'picking_type_id': types and types[0] or False})
    ...
    #     res = super(MrpProduction,self)._make_production_produce_line(cr, uid, production, context)
    ...
    #                                                                   remaining_qty, False, 0, context=context)
    ...
    #     # res = super(MrpProduction, self).action_produce(cr, uid, production_id, production_qty, production_mode,
    #     #                                                 wiz, context)
    #     return True
