...
class SampleDevelopmentReport(models.AbstractModel):
    ...
    def render_html(self,docids, data=None):
        ...
        records = self.env['customer.payment.bcube'].search([('branch','=',record_wizard.branch.id),('journal_id','=',record_wizard.journal_id.id),('date','>=',record_wizard.date_from),('date','<=',record_wizard.date_to)])
